...
func (r *Both) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Both":
		...
		case "ContainerEcho":
			...
			return (*Both).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent Both
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Both).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
